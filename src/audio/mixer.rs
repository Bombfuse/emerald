...
impl<'a> MixerHandler<'a> {
    ...
    pub fn set_instance_volume(&mut self, snd_instance_id: SoundInstanceId, volume: f32) -> Result<(), EmeraldError> { self.inner.set_instance_volume(snd_instance_id, volume) }
